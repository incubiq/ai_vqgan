...
def checkin(i, losses):
    ...
    img.save("_generated/"+splitF2+splitF[1], pnginfo=info) 	
    img.save("_temp/"+splitF2+"_"+str(i)+splitF[1], pnginfo=info) 	    
    print("saved file: "+splitF2+"_"+str(i)+splitF[1]) 	    
#todo I have modified few lines above...
